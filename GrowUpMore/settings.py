...
SECRET_KEY = 'django-insecure-d-cy2b*b&ohk26=(y8eh^-abq!w54t#u84*qq4fyp49)y!!_0l'
...
DATABASES['default']['OPTIONS'] = {
    'options': '-c search_path=public,master,hr',
}
...
# Additional configurations for file upload handling (optional)
